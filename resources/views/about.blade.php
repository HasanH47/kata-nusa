...
<div class="max-w-4xl mx-auto">
    ...
    <div class="text-center mb-16">
        <h1 class="text-4xl font-bold text-gray-900 mb-4">Tentang KataNusa</h1>
        <p class="text-xl text-gray-600">Menyatukan Cerita dari Seluruh Nusantara</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-8 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
                ...
                <h3 class="font-bold text-gray-900 mb-1">Nama Lengkap</h3>
                <p class="text-gray-600 mb-2">Posisi</p>
        ...
        <form class="space-y-6">
            ...
            <div>
                ...
                <textarea id="message"
                          ...
                          rows="4"
                          required
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"></textarea>
            </div>
